...
# Define Constants
fresh_data = True
data_path = '../../data/clique/simple.csv'
fig_path = '../../results/clique/simple.png'
...
if fresh_data:
    ...
    trial_infections = []
    num_cliques = linspace(1, 125, 40).astype(int)
    for num in num_cliques:
        simple_cliques(net, num, budget, cliques=cliques)
